...
namespace FractalViewer
{
    ...
    class Input
    {
        ...
        public static void Instantiate(Window window)
        {
        ...
        private static void OnMoveMouse(MouseMoveEventArgs e)
        {
            mousePosition = e.Position;
            mouseDeltaPosition = e.Delta;
        }
        private static void OnMouseWheel(MouseWheelEventArgs e)
        {
            mouseWheel = e.OffsetY;
        }
